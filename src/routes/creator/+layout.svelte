...
<!-- {@render children()} -->
<div class="min-w-screen min-h-screen bg-base-200">
	<div class="drawer sm:drawer-open">
		...
		<div class="drawer-side">
			...
			<ul class="menu menu-lg p-4 w-80 min-h-full bg-base-100 lg:border-r text-primary">
				<h1 class="text-2xl font-semibold tracking-wider text-base-100 capitalize dark:text-white">
					Welcome back,
				</h1>
				...
				<li>
					<a class="{selectedPage === 'home' ? 'bg-base-200' : ''}" href="/account/home">
						<svg
							xmlns="http://www.w3.org/2000/svg"
							class="h-5 w-5"
							fill="none"
				...
				<!-- <li>
					<a class="mt-3" href="/account/billing">
				...
				<li>
					<a class="mt-3 {selectedPage === 'settings' ? 'bg-base-200' : ''}" href="/account/settings">
				...
				<li class="mt-auto bg-primary *:text-primary-content rounded-sm">
